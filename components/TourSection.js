...
export default function TourSection() {
  ...
  const tourDates = [
    ...
    { date: "16.MAY", year: 2026, location: "LA PAZ, MX - FIESTAS DE FUNDACIÓN" },
    { date: "30.MAY", year: 2026, location: "ACAPULCO, MX - TONIC FEST" },
    { date: "13.JUN", year: 2026, location: "TEXCOCO, MX - CASCARITA FUT FEST" },
  ...
  const tourLinks = {
    ...
    "30.MAY": "https://www.tonicevent.com/evento/tonic-fest-acapulco-2026?dia=30",
